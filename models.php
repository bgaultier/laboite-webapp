<?php
  ...
  function update_user_app($userid, $values)
  {
    ...
    $query = "UPDATE user_apps SET city ='" . mysql_real_escape_string($values['city']) . "', login ='" . mysql_real_escape_string($values['login']) . "', password ='" . mysql_real_escape_string($values['password']) . "', apikey ='" . mysql_real_escape_string($values['apikey']) . "', stop ='" . mysql_real_escape_string($values['stop']) . "', station ='" . mysql_real_escape_string($values['station']) . "' WHERE userid =$userid AND appid =" . mysql_real_escape_string($values['id']) . " LIMIT 1 ;";
    $result = mysql_query($query);
